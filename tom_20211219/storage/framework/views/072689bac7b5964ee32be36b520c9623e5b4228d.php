  ...
  <form action="<?php echo e(route('students.update', ['student' => $data['id']])); ?>" method="post"
    ...
    <table class="center" border="1px" width="80%">
      ...
      <tr>
        ...
        <td>
          <img src="<?php echo e(asset("storage/img/$data->photo")); ?>" alt="無資料" width=200>
        ...
        <td><input type="text" name="location" id="location" value="<?php echo e($data->location->location_name); ?>">
        </td>
        
        <td><input type="text" name="phone" id="phone" value="<?php echo e($data->phoneRelation->phone); ?>"></td>
        <td> <input type="text" name="love" id="love" value="<?php echo e($data['love']); ?>"> <br> </td>
      </tr>
...
<?php /**PATH C:\laravel\tom_20211219\resources\views/student/edit.blade.php ENDPATH**/ ?>