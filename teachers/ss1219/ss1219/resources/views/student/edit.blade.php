    ...
    <form action="{{ route('students.update', ['student' => $data['id']]) }}" method="post"
        ...
        <table class="center" border="1px" width="80%">
            ...
            <tr>
                ...
                @if (!empty($data->phoneRelation->student_id))
                    <td><input type="text" name="phoneInput" id="phone" value="{{$data->phoneRelation->phone}}"></td>
                @else
                    <td><input type="text" name="phoneInput" id="phone" value=""></td>
                @endif
               
                <td><input type="number" name="love" id="love" value="{{ $data->love }}"></td>
            </tr>
